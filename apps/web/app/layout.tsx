  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${geist.variable} ${montserrat.variable} ${merriweather.variable} ${dmMono.variable}`}>
      ...
      <body className={geist.className}>
        ...
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }} alt="" src="https://px.ads.linkedin.com/collect/?pid=8803626&fmt=gif" />
        </noscript>
        {/* Meta Pixel */}
        <Script id="meta-pixel" strategy="afterInteractive">
          {`
            ...
            fbq('init', '1980144946219194');
            fbq('track', 'PageView');
          `}
        </Script>
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }} alt="" src="https://www.facebook.com/tr?id=1980144946219194&ev=PageView&noscript=1" />
        </noscript>
      </body>
    </html>
  );
