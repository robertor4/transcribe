                ...
                <ScrollAnimation delay={300}>
                  <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
                    ...
                    <Link
                      ...
                      className="text-gray-400 hover:text-gray-200 font-normal transition-colors underline decoration-gray-500/50 underline-offset-4 py-4"
                    >
                      {t('hero.ctaSecondary')}
                    </Link>
                  </div>
              ...
              <ScrollAnimation delay={400}>
                <div className="flex justify-center lg:justify-end">
                  {/*
                    ...
                    - Max width: 420px
                  */}
                  <div className="w-full max-w-md bg-white rounded-lg shadow-xl border border-gray-200 p-8 text-left transform lg:rotate-1 hover:rotate-0 transition-transform duration-300">
