...
interface AssetSidebarCardProps {
...
function getContentPreview(asset: GeneratedAnalysis): string {
...
export function AssetSidebarCard({ asset, onClick, isActive = false }: AssetSidebarCardProps) {
