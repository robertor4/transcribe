...
export function ExportPDFMenuItem({
  ...
  return (
    <button
      ...
      className="w-full flex items-center gap-2.5 px-3 py-2 text-[13px] font-medium text-gray-700 dark:text-gray-300 hover:bg-accent transition-colors disabled:opacity-50 rounded-md"
    >
      {isGenerating ? (
