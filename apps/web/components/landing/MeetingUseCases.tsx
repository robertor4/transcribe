...
export function MeetingUseCases({ title, subtitle, useCases: useCaseStrings }: MeetingUseCasesProps) {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900" aria-labelledby="meeting-use-cases-heading">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <ScrollAnimation>
            <h2 id="meeting-use-cases-heading" className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              {title}
            </h2>
          ...
          {useCases.map((useCase, index) => {
            ...
            return (
              <ScrollAnimation
                ...
                delay={index * 100}
              >
                <div className={`bg-gradient-to-br ${useCase.bgGradient} rounded-2xl p-8 h-full border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all hover-lift`}>
