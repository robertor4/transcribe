...
export function LanguageSwitcher({ enableDarkMode = false }: LanguageSwitcherProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className={`absolute right-0 z-50 mt-2 w-48 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 ${enableDarkMode ? 'dark:bg-gray-800 dark:ring-gray-700' : ''}`}>
